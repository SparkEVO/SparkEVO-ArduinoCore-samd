...
#define EEPROM_ADDR_LAPTIMERMODE 26				// 1 byte
#define EEPROM_ADDR_ENABLEMASTERLIDAR 27		// 1 byte ("drag" mode)
#define EEPROM_ADDR_OUTPUTSIGNALMODE 28			// 1 byte
#define EEPROM_ADDR_OUTPUTSIGNALDURATION 29		// 1 byte
